...
__global__ void matrixMultiplyShared(float *A, float *B, float *C,
  ...
  __shared__ float tileA[MAX_TILE_WIDTH][MAX_TILE_WIDTH];
  __shared__ float tileB[MAX_TILE_WIDTH][MAX_TILE_WIDTH];
  ...
  int numTiles = (numAColumns + blockSize - 1) / blockSize;
