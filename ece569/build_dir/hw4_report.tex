...
%  Workflow:
%    1. sbatch run_exp1.slurm && sbatch run_exp2.slurm
%    2. git pull  (to get output files locally)
%    3. python3 parse_times.py --inject hw4_report.tex
%    4. pdflatex hw4_report.tex
% ============================================================
...
\graphicspath{{Histogram_output/figures/}}
