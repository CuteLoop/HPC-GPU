...
ASSIGNMENT2_DIR=/home/u16/joelmaldonado/HPC-GPU/Assignment2
LIBWB_TARGET="$ASSIGNMENT2_DIR/libwb"
...
cmake -D CUDA_TOOLKIT_ROOT_DIR=/opt/ohpc/pub/apps/cuda/11.8 "$ASSIGNMENT2_DIR"
